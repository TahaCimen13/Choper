...
export default function UyeOlPage() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      setError("Bu e-posta adresi zaten kullanılıyor olabilir.");
    }
    setLoading(false);
  }
      ...
      <div className="w-full max-w-md">
        <div className="rounded-2xl border border-border bg-surface p-8 shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="name" className="mb-1.5 block text-xs font-medium uppercase tracking-wider text-text-secondary">
                Ad Soyad
              </label>
              <input
                id="name"
            ...
            <div>
              <label htmlFor="passwordConfirm" className="mb-1.5 block text-xs font-medium uppercase tracking-wider text-text-secondary">
                Şifre Tekrar
              </label>
              <input
                id="passwordConfirm"
          ...
          <p className="mt-6 text-center text-sm text-text-muted">
            ...
            <Link href="/giris" className="font-medium text-gold transition-colors hover:text-gold-dark">
              Giriş Yap
            </Link>
          </p>
        </div>
